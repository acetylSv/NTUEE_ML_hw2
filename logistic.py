...
def train(X_all, Y_all, save_dir):
    ...
    if using_ADAGRAD:
        ...
        e = 1e-8
        w_grad_accumulate = np.zeros(106)
        b_grad_accumulate = 0.0
    ...
    for epoch in range(1, epoch_num):
        ...
        for idx in range(step_num):
            ...
            if using_ADAGRAD:
                ...
                w_grad_accumulate += w_grad**2
                b_grad_accumulate += b_grad**2
                
                w = w - l_rate * (1.0 / (w_grad_accumulate**0.5 + e)) * w_grad
                b = b - l_rate * (1.0 / (b_grad_accumulate**0.5 + e)) * b_grad
